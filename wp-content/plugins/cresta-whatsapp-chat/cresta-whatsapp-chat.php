<?php
/**
 * Plugin Name: Cresta WhatsApp Chat
 * Plugin URI: https://crestaproject.com/downloads/cresta-whatsapp-chat/
 * Description: <strong>*** <a href="https://crestaproject.com/downloads/cresta-whatsapp-chat/?utm_source=plugin_whatsapp&utm_medium=description_meta" target="_blank">Get Cresta WhatsApp Chat PRO</a> ***</strong> Allow your users and customers to contact you via WhatsApp with a single click.
 * Version: 1.0.8
...
define( 'CRESTA_WHATSAPP_CHAT_PLUGIN_VERSION', '1.0.8' );
...
function cresta_whatsapp_chat_menu() {
	...
	$cresta_whatsapp_options_page = add_options_page( esc_html__( 'Cresta WhatsApp Chat Settings'), 'Cresta WhatsApp Chat', 'manage_options', 'cresta-whatsapp-chat.php', 'cresta_whatsapp_chat_option', 81 );
}
...
function cresta_whatsapp_chat_meta_links( $links, $file ) {
	if ( strpos( $file, 'cresta-whatsapp-chat.php' ) !== false ) {
		$new_links = array(
			'<a style="color:#39b54a;font-weight:bold;" href="https://crestaproject.com/downloads/cresta-whatsapp-chat/?utm_source=plugin_whatsapp&utm_medium=upgrade_meta" target="_blank" rel="external" ><span class="dashicons dashicons-megaphone"></span> ' . esc_html__( 'Upgrade to PRO', 'cresta-whatsapp-chat' ) . '</a>', 
		);
...
function crestawhatsappplugin_front_enqueue_scripts() {
	wp_enqueue_style( 'cresta-whatsapp-chat-front-style', plugins_url('css/cresta-whatsapp-chat-front-css.css',__FILE__), array(), CRESTA_WHATSAPP_CHAT_PLUGIN_VERSION);
}
...
function register_cresta_whatsapp_chat_settings() {
	...
	$cwc_options_arr = array(
		...
		'cresta_whatsapp_chat_box_text' => 'Cresta WhatsApp Chat',
...
function cresta_whatsapp_chat_option() {
	...
	<div class="wrap">
		...
		<a class="crestaButtonUpgrade" href="https://crestaproject.com/downloads/cresta-whatsapp-chat/?utm_source=plugin_whatsapp&utm_medium=insideoption_meta" target="_blank" title="<?php esc_attr_e('See Details: Cresta WhatsApp Chat PRO', 'cresta-whatsapp-chat'); ?>"><span class="dashicons dashicons-megaphone"></span><?php esc_html_e('Upgrade to PRO version!', 'cresta-whatsapp-chat'); ?></a>
		<h2><?php esc_html_e('Cresta WhatsApp Chat FREE', 'cresta-whatsapp-chat'); ?></h2>
		<div id="poststuff">
...
<pre><code>[cresta-whatsapp-chat text="Need Help? Contact Me!" icon="yes" position="top" use="number" number=""]</code></pre>
								</span>
							</td>
						</tr>
						<tr valign="top">
...
<pre><code>&lt;?php
	if(function_exists(&#039;cresta_whatsapp_chat_shortcode&#039;)) {
		echo do_shortcode('[cresta-whatsapp-chat text="Need Help? Contact Me!" icon="yes" position="left" use="group" group=""]');
	}
?&gt;</code></pre>
								</span>
							</td>
				...
				<div id="postbox-container-1" class="postbox-container">
					<div class="meta-box-sortables">
						<div class="postbox">
							...
							<div class="inside">
								<?php echo wp_kses_post( 'Do not forget to rate <strong>Cresta WhatsApp Chat</strong> on WordPress Pugins Directory.<br/>We really appreciate it ;)', 'cresta-whatsapp-chat' ); ?>
								<br/>
								<img src="<?php echo esc_url( plugins_url( '/images/5-stars.png' , __FILE__ )); ?>">
								<br/>
								<a class="crestaButton" href="https://wordpress.org/support/plugin/cresta-whatsapp-chat/reviews/#new-post"title="<?php esc_attr_e( 'Rate Cresta WhatsApp Chat on Wordpress Plugins Directory', 'cresta-whatsapp-chat' ); ?>" class="btn btn-primary" target="_blank"><?php esc_html_e( 'Rate Cresta WhatsApp Chat', 'cresta-whatsapp-chat' ); ?></a>
							</div> <!-- .inside -->
						</div> <!-- .postbox -->
						...
						<div class="postbox" style="border: 4px solid #25d366;">
							...
							<div class="inside">
								<a href="https://crestaproject.com/downloads/cresta-whatsapp-chat/?utm_source=plugin_whatsapp&utm_medium=moreinfo_meta" target="_blank" alt="Get Cresta WhatsApp Chat PRO"><img src="<?php echo esc_url(plugins_url( '/images/banner-cresta-whatsapp-chat-pro.png' , __FILE__ )); ?>"></a><br/>
								<?php echo wp_kses_post( 'Get <strong>Cresta WhatsApp Chat PRO</strong> for only', 'cresta-whatsapp-chat' ); ?> <strong>9,99&euro;</strong><br/>
								<ul>
								...
								<a class="crestaButton" href="https://crestaproject.com/downloads/cresta-whatsapp-chat/?utm_source=plugin_whatsapp&utm_medium=moreinfo_meta" target="_blank" title="<?php esc_attr_e( 'More Details', 'cresta-whatsapp-chat' ); ?>"><?php esc_html_e( 'More Details', 'cresta-cresta-whatsapp-chat' ); ?></a>
							</div> <!-- .inside -->
						 </div> <!-- .postbox -->
