...
final class Adapta_RGPD {
	...
	public function requirements_not_met_notice() {
		...
		$default_message = sprintf( __( 'La instalaci&oacute;n no cumple los requisitos, Adapta RGPD necesita al menos PHP 5.4, y el plugin ha sido <a href="%s">desactivado</a>.', 'adaptargpd' ), admin_url( 'plugins.php' ) );
